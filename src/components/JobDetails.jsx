...
const JobDetails = () => {
  ...
  <div class="absolute bottom-0 left-0 w-[250px] h-[200px] bg-no-repeat bg-cover"
       style={{ backgroundImage: `url(${headerImage2})` }}>
  </div>
  <div class="absolute -top-12 right-0 w-[250px] h-[200px] bg-no-repeat bg-cover"
    ...
    <div class="text-black text-4xl font-bold ">Job Details</div>
      ...
      <div className="mt-32 md:w-[80%] mx-auto md:flex gap-6">
        ...
        <div className="bg-gradient-to-r from-indigo-100 to-purple-200 bg-opacity-10 border rounded-md p-4">
          ...
          <button className="btn-main mt-7 w-full hover:bg-gradient-to-l hover:bg-cyan-800 ">
            Apply Now
          </button>
        </div>
      </div>
